...
public abstract class Move { //this is abstract because we have two type of moves attacking moves and non attacking moves
    ...
    protected final Board board; // to keep track of board on we moved on
    protected final Piece movedPiece; // to keep track of the piece we have moved
    protected final int destinationCoordinate; // where we want to move that piece
    ...
    public int hashCode() {
        ...
        result = prime * result + this.movedPiece.getPiecePostion();
    ...
    public static class MoveFactory {
        ...
        public static Move createMove(final Board board,
                                      ...
                                      final int destinationCoordinate) {
            for (final Move move : board.getAllLegalMoves()) { //check for all legal moves. Is it a legal move we perform by currentCoordinate and destinationCoordinate
